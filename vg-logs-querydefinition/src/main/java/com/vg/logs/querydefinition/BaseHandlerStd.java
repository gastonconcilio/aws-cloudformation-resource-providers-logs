...
public abstract class BaseHandlerStd extends BaseHandler<CallbackContext> {
    ...
    protected boolean exists(final ProxyClient<CloudWatchLogsClient> proxyClient,
        ...
        final DescribeQueryDefinitionsRequest translateToReadRequest = Translator.translateToReadRequest(model);
        final DescribeQueryDefinitionsResponse response;
        try {
            response = proxyClient.injectCredentialsAndInvokeV2(translateToReadRequest, proxyClient.client()::describeQueryDefinitions);
